...
const styles = StyleSheet.create({
  ...
  categoryBadge: { backgroundColor: '#16a34a', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 4 },
  ...
  championLabel: { fontSize: 13, fontWeight: '700', color: '#16a34a', marginBottom: 10, letterSpacing: 2 },
  ...
  finalMatch: { borderWidth: 1, borderColor: '#16a34a' },
  finalBanner: { backgroundColor: '#16a34a', paddingVertical: 4, alignItems: 'center' },
  ...
  winnerSlot: { backgroundColor: 'rgba(22, 163, 74, 0.08)' },
  ...
  winCheck: { color: '#16a34a', fontSize: 14, fontWeight: '700', marginRight: 6 },
